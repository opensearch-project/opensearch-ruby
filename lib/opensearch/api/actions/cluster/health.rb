  ...
  module API
    module Cluster
      module Actions
        ...
        # @option args [Integer, NilClass, String] :wait_for_active_shards (default: 0) Waits until the specified number of shards is active before returning a response. Use `all` for all shards.
