    ...
    module FlowFramework
      module Actions
        ...
        def deprovision(args = {})
          ...
          raise ArgumentError, "Required argument 'workflow_id' missing" unless args['workflow_id']
          ...
          method  = 'POST'
          url     = ['_plugins/_flow_framework/workflow', _workflow_id, '_deprovision'].filter(&:present?).join('/').squeeze('/')
