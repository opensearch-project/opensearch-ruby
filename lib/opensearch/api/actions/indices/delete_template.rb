  ...
  module API
    module Indices
      module Actions
        ...
        #
        # @option args [String] :name *Required* The name of the legacy index template to delete. Wildcard (`*`) expressions are supported.
        ...
        def delete_template(args = {})
          ...
          method  = 'DELETE'
          url     = ['_template', _name].filter(&:present?).join('/').squeeze('/')
