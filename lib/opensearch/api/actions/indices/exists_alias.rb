  ...
  module API
    module Indices
      module Actions
        ...
        #
        # @option args [Enumerable<String>, String] :name *Required* Comma-separated list of aliases to check. Supports wildcards (`*`).
        ...
        def exists_alias(args = {})
          ...
          method  = 'HEAD'
          url     = [_index, '_alias', _name].filter(&:present?).join('/').squeeze('/')
