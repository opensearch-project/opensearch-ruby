  ...
  module API
    module Indices
      module Actions
        ...
        # @option args [Boolean] :flush Specify whether the index should be flushed after performing the operation.
        ...
        # @option args [Boolean] :wait_for_completion Should the request wait until the force merge is completed.
        ...
        def forcemerge(args = {})
          ...
          method  = 'POST'
          url     = [_index, '_forcemerge'].filter(&:present?).join('/').squeeze('/')
