  ...
  module API
    module Indices
      module Actions
        ...
        #
        # @option args [Enumerable<String>, String] :fields *Required* Comma-separated list or wildcard expression of fields used to limit returned information.
        ...
        def get_field_mapping(args = {})
          ...
          raise ArgumentError, "Required argument 'fields' missing" unless args['fields']
          ...
          method  = 'GET'
          url     = [_index, '_mapping/field', _fields].filter(&:present?).join('/').squeeze('/')
