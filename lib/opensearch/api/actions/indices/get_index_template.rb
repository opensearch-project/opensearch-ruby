  ...
  module API
    module Indices
      module Actions
        ...
        # @option args [String] :name Name of the index template to retrieve. Wildcard (*) expressions are supported.
        def get_index_template(args = {})
          ...
          method  = 'GET'
          url     = ['_index_template', _name].filter(&:present?).join('/').squeeze('/')
