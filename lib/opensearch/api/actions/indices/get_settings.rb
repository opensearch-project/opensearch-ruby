  ...
  module API
    module Indices
      module Actions
        ...
        # @option args [Enumerable<String>, String] :name Comma-separated list or wildcard expression of settings to retrieve.
        ...
        def get_settings(args = {})
          ...
          method  = 'GET'
          url     = [_index, '_settings', _name].filter(&:present?).join('/').squeeze('/')
