  ...
  module API
    module Indices
      module Actions
        ...
        #
        # @option args [String] :index *Required* Name of the source index to shrink.
        ...
        def shrink(args = {})
          ...
          raise ArgumentError, "Required argument 'target' missing" unless args['target']
          ...
          method  = 'POST'
          url     = [_index, '_shrink', _target].filter(&:present?).join('/').squeeze('/')

          Utils.validate_query_params args, SHRINK_QUERY_PARAMS
          transport.perform_request(method, url, args, body, headers).body
        end

        SHRINK_QUERY_PARAMS = Set.new(%w[
