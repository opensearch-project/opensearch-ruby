  ...
  module API
    module Knn
      module Actions
        ...
        # @option args [Enumerable<String>, String] :stat A comma-separated list of stats to retrieve; use `_all` or empty string to retrieve all stats.
        def stats(args = {})
          ...
          method  = 'GET'
          url     = Utils.build_url('_plugins/_knn', _node_id, 'stats', _stat)
