  ...
  module API
    module Ltr
      module Actions
        ...
        # @option args [Hash] :body *Required* The feature definition.
        def create_feature(args = {})
          ...
          Utils.validate_query_params! args, CREATE_FEATURE_QUERY_PARAMS
          transport.perform_request(method, url, args, body, headers).body
        end

        CREATE_FEATURE_QUERY_PARAMS = Set.new(%w[
          routing
        ]).freeze
      end
    end
