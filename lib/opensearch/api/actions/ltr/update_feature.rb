  ...
  module API
    module Ltr
      module Actions
        ...
        # @option args [Hash] :body *Required* The updated feature definition.
        def update_feature(args = {})
          ...
          Utils.validate_query_params! args, UPDATE_FEATURE_QUERY_PARAMS
          transport.perform_request(method, url, args, body, headers).body
        end

        UPDATE_FEATURE_QUERY_PARAMS = Set.new(%w[
          routing
        ]).freeze
      end
    end
