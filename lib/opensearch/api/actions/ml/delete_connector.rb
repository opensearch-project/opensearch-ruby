    ...
    module Ml
      module Actions
        ...
        def delete_connector(args = {})
          ...
          raise ArgumentError, "Required argument 'connector_id' missing" unless args['connector_id']
          ...
          method  = 'DELETE'
          url     = ['_plugins/_ml/connectors', _connector_id].filter(&:present?).join('/').squeeze('/')
