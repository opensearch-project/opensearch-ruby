    ...
    module Observability
      module Actions
        ...
        def get_object(args = {})
          ...
          raise ArgumentError, "Required argument 'object_id' missing" unless args['object_id']
          ...
          method  = 'GET'
          url     = ['_plugins/_observability/object', _object_id].filter(&:present?).join('/').squeeze('/')
