    ...
    module Query
      module Actions
        ...
        def datasource_delete(args = {})
          ...
          raise ArgumentError, "Required argument 'datasource_name' missing" unless args['datasource_name']
          ...
          method  = 'DELETE'
          url     = ['_plugins/_query/_datasources', _datasource_name].filter(&:present?).join('/').squeeze('/')
