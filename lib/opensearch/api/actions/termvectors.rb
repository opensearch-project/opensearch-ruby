  ...
  module API
    module Root
      module Actions
        ...
        # @option args [Boolean] :field_statistics If `true`, the response includes the document count, sum of document frequencies, and sum of total term frequencies.
        ...
        # @option args [Boolean] :offsets If `true`, the response includes term offsets.
        # @option args [Boolean] :payloads If `true`, the response includes term payloads.
        # @option args [Boolean] :positions If `true`, the response includes term positions.
        ...
        def termvectors(args = {})
          ...
          url     = [_index, '_termvectors', _id].filter(&:present?).join('/').squeeze('/')
