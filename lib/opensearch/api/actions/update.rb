  ...
  module API
    module Root
      module Actions
        ...
        # @option args [String] :lang The script language.
        ...
        # @option args [Integer] :retry_on_conflict Specify how many times should the operation be retried when a conflict occurs.
        ...
        def update(args = {})
          ...
          method  = 'POST'
          url     = [_index, '_update', _id].filter(&:present?).join('/').squeeze('/')
