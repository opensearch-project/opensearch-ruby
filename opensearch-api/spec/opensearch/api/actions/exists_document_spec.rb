...
describe 'client#exists' do
  ...
  context 'when the type parameter is not provided' do
    ...
    it 'performs the request' do
      expect(client_double.exists(index: 'foo', id: '1')).to be(true)
    end
  end
  ...
  context 'when URL parameters are provided' do
    ...
    it 'passes the parameters' do
      expect(client_double.exists(index: 'foo', id: '1', routing: 'abc123')).to be(true)
    end
  end
  ...
  context 'when the request needs to be URL-escaped' do
    ...
    it 'URL-escapes the characters' do
      expect(client_double.exists(index: 'foo^bar', id: '1')).to be(true)
    end
  end
  ...
  context 'when the response is 404' do
    ...
    it 'returns false' do
      expect(client_double.exists(index: 'foo', id: '1')).to be(false)
    end
  end
