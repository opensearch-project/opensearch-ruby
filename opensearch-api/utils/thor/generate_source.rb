...
module Opensearch
  module API
    ...
    class SourceGenerator < Thor
      ...
      def __http_method
        return '_id ? Opensearch::API::HTTP_PUT : Opensearch::API::HTTP_POST' if @endpoint_name == 'index'
        ...
        if @spec['body'] && default_method == 'GET'
          ...
          "Opensearch::API::HTTP_#{default_method}"
        end
      end
      ...
      def __utils
        (@current_api == :xpack) ? 'Opensearch::API::Utils' : 'Utils'
      end
