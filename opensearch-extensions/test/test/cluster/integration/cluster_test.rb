...
class Opensearch::Extensions::TestClusterIntegrationTest < Opensearch::Test::IntegrationTestCase
      ...
      should "start and stop #{build.to_s}" do
        ...
        begin
          Opensearch::Extensions::Test::Cluster.start \
            command: PATH_TO_BUILDS.join(build.join('bin/opensearch')).to_s,
            port: 9260,
            cluster_name: 'opensearch-ext-integration-test',
            path_data: '/tmp/opensearch-ext-integration-test'
