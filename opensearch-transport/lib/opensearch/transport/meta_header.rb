    ...
    module MetaHeader
      def set_meta_header
        ...
        meta_headers = {
          ...
          rb: RUBY_VERSION,
          t: OpenSearch::Transport::VERSION
        }
      ...
      def meta_header_service_version
        if enterprise_search?
          ...
          Elastic::OPENSEARCH_SERVICE_VERSION
        elsif defined?(OpenSearch::VERSION)
          [:es, client_meta_version(OpenSearch::VERSION)]
        else
          [:es, client_meta_version(OpenSearch::Transport::VERSION)]
        end
      end
      ...
      def opensearch?
        defined?(Elastic::OPENSEARCH_SERVICE_VERSION) &&
          called_from?('opensearch')
      end
