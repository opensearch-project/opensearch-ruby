...
Gem::Specification.new do |s|
  ...
  s.email         = ['karel.minarik@opensearch.org']
  ...
  s.metadata = {
    ...
    'source_code_uri' => 'https://github.com/elastic/opensearch-ruby/tree/7.x/opensearch-transport',
  ...
  s.description = <<-DESC.gsub(/^    /, '')
    Ruby client for Elasticsearch. See the `opensearch` gem for full integration.
  DESC
end
